...
If note is in _italics_ then it's manually reduced so not to span hundreds of lines here, otherwise this file notes (if any) is _autogenerated from MAME source_
